...
<body id="iframe">
    ...
    <!-- Main content -->
    <div class="content-wrapper containerInsideIframe">

        <!-- Page header -->
        <div class="page-header page-header-default">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-left52 position-left"></i> <span id="teste-notification" class="text-semibold">Home</span> - Dashboard</h4>
                </div>

                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a name="btn-statistics" class="btn btn-link btn-float text-size-small has-text"><i class="icon-bars-alt text-primary"></i><span>Statistics</span></a>
                        <a name="btn-invoices" class="btn btn-link btn-float text-size-small has-text"><i class="icon-calculator text-primary"></i> <span>Invoices</span></a>
                        ...
                        <div class="table-responsive">
                            <table class="table text-nowrap">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="../../cdn/Vendor/limitless/material/images/brands/facebook.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="../../cdn/Vendor/limitless/material/images/brands/youtube.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="../../cdn/Vendor/limitless/material/images/brands/spotify.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="../../cdn/Vendor/limitless/material/images/brands/twitter.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="../../cdn/Vendor/limitless/material/images/brands/bing.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="../../cdn/Vendor/limitless/material/images/brands/amazon.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="../../cdn/Vendor/limitless/material/images/brands/dribbble.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active fade in has-padding" id="messages-tue">
                                <ul class="media-list">
                                    <li class="media">
                                        <div class="media-left">
                                            <img src="../../cdn/Vendor/limitless/material/images/placeholder.jpg" class="img-circle img-xs" alt="">
