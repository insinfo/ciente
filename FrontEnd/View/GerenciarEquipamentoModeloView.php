...
<head>
    ...
    <script type="text/javascript" src="ViewModel/GerenciarEquipamentoModeloViewModel.js"></script>
                                                ...
                                                <form id='formEquipamentoModelo' class="form-horizontal" action="#" onSubmit='return false'>
                                                    <div class="form-horizontal">
                                                        <fieldset class="content-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label control-label col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-1">Descrição</label>
                                                                <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 col-xl-11">
                                                                    <textarea id="descricao" name="descricao" rows="3" cols="5" class="form-control" placeholder="Descrição do modelo"></textarea>
                                                                </div>
                                                            </div>
